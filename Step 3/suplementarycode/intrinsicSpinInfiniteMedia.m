...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Explore SpinState
SpinState = 1; % 1 for P-P Interaction, 2 for S-S interaction, 3 for P-S Hybrid Interaction
SpinPlotAlong =0; % Angle in degree
t1=34.00;
t2=-34.00;
%% WAVE - AMPLITUDES 
%Amplitude of P-waves
A1 = 0.000001; % amplitude of L-Wave 1
A2 = 0.000001; % amplitude of L-Wave 2

% Amplitude of S-waves
B1 = 0.000001; % amplitude of T-Wave 1
B2 = 0.000001; % amplitude of T-Wave 2
...
num_points_x = 800; % number of points in the x direction
